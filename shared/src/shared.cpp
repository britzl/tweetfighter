...
static void* LoadLibrary(const char* path)
{
    ...
    dmLogWarning("framework path: %s", buffer);
...
{
    g_TestLibrary = LoadLibrary("libshared");
...
DM_DECLARE_EXTENSION(shared, LIB_NAME, AppInitializeMyExtension, AppFinalizeMyExtension, InitializeMyExtension, 0, 0, FinalizeMyExtension);
